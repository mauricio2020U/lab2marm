<div class="container-fluid">
                                <div class="row">
                                    <div class="form-group col">
                                        ...
                                        <input type="text" name="codprod" class="form-control form-control-sm col-sm-4" id="codprod" placeholder="Ej: AA-0001" value="{{ $productos->codprod }}">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col">
                                ...
                                <div class="row">
                                    <div class="form-group col">
                                        ...
                                        <input type="text" name="descriprod" class="form-control form-control-sm col-sm-10" id="nombreprod" placeholder="Descripción del producto" value="{{ $productos->descriprod }}">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col">
                                        <label class="col-form-label col-form-label-sm" for="typprod">Tipo de Producto</label>
                                        <input type="text" name="typprod" class="form-control form-control-sm col-sm-10" id="typprod" placeholder="Tipo de producto" value="{{ $productos->typprod }}">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col">
                                ...
                                <div class="row">
                                    <div class="form-group col">
                                        ...
                                        <input type="number" name="cantprod" class="form-control form-control-sm col-sm-4" id="cantprod" placeholder="0000" value="{{ $productos->cantprod }}">
                                    </div>
                                </div>
                            </div>
