...
//Route::get('productos','App\Http\Controllers\HomeController@indexprod')->name('productos');
...
Route::put('/productos/{id}', [App\Http\Controllers\ProductosController::class,'update']);